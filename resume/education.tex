  ...
  \cventry
    ...
    {Sept. 2019 - June 2022} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
        ...
        \item Writing a dissertation on Continuous Delivery (CD) In Student Teams, implementing and analysing the effect of CD pipelines
        \item Predicted First Class degree based on previous year
